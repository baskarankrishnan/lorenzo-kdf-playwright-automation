...
export const lnkSubTaskPaneInpatient = "((//div[contains(@atei,'Inpatient')]//span[normalize-space()='<variable>'])[2] | (//div[contains(@atei,'Inpatient')]//span[normalize-space()='<variable>'])[1] | (//span[normalize-space()='<variable>' and ancestor::div[contains(@atei,'Inpatient')]])[1])";
...
export const SelectSession = "(//img[@alt='Click to select row' and @title='Click to select row'] | //img[@title='Click to select row'] | //td[@title='Click to select row']//img | //tr[contains(@id,'igRow')][1]//img[contains(@title,'select row')])[1]";
...
export const cmb_CodStatus = "//input[@id='icombobox_Text_C39']";
